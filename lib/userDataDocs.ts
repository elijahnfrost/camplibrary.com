...
import { DEFAULT_CAMP_DOCUMENTS, normalizeCampDocuments, type CampDocument } from "./campDocuments";
...
// validator lives in lib/campDocuments.ts (isomorphic); it drops malformed rows
// and keeps only sources the browser can actually open.
export const documentsDoc: StorageValidator<CampDocument[]> = (value, fallback) =>
