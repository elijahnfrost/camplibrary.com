...
import { matchesActivityFilters, sortActivities, isLibrarySort, type LibrarySort } from "@/lib/activity/activityFilters";
...
export function CampApp({ initialTab = "calendar" }: { initialTab?: TabId } = {}) {
  ...
  // The library filter-bar state (categories / place / age / theme / starred /
  // kit lens / material narrowing / query / duration slider) lives in
  // useLibraryFilters — hoisted above LibraryTab so the desktop sidenav rail can
  // drive it.
  const {
    cats,
    setCats,
