...
import { ageSpan, durLabel, effectiveEventColor, ENERGY, groupLabel } from "@/lib/content/data";
import { materialNeedsForActivity, materialOptionsForActivities } from "@/lib/materials/materials";
